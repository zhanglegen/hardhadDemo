    ...
    AccessControlUpgradeable
{
    ...
    */
    ...
    struct User { // 记录用户相对每个资金池 的质押记录
        ...
        uint256 finishedMetaNode; // 用户在当前资金池的奖励计算基准值
     ...
     */
    function updatePoolConfig(uint256 _pid, uint256 _minDepositAmount, uint256 _unstakeLockedBlocks) public onlyRole(ADMIN_ROLE) checkPid(_pid) {
